...
const template = `
    <form id='quest-generator'>
        ...
        <label id='templateName' class='pure-material-textfield-filled'>
          <textarea class='template-name ${currentTheme()}' name='rscrch-name' placeholder='Название исследования' autofocus
          ></textarea>
          <span></span>
        </label>
      ...
      <div>
        ...
        <label id='description' class="pure-material-textfield-filled">
          <textarea class='${currentTheme()}' name='rsrchdescription' placeholder='Описание исследования'
          ></textarea>
          <span></span>
        </label>
      ...
      <div>
        ...
        <div div class = 'additional-information card ${currentTheme()}'>
          <div class='checks ${currentTheme()}'>
       ...
       <div>
        ...
        <div class='rest-information card ${currentTheme()}'>
          ...
          <div class = 'possible-answers' >
            <select id='possibleAnswersType' class='${currentTheme()}' name='possible-answers'>
