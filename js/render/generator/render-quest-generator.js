...
import { addExtraField, delExtraField, rangeTemplate } from "./generator-extra-fields/extra-fields.js";
...
function renderQuestGenerator() {
  ...
  const form = ROOT_DIV.querySelector('div > form'),
    ...
    delExtraFieldBtn = ROOT_DIV.querySelector('.del-extra-field');
  
  delExtraFieldBtn.style.display = 'none';

  delExtraFieldBtn.addEventListener('click', delExtraField)
